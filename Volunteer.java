...
public class Volunteer
{
	public static void main(String[] args) 
	{
		...
		// this loop will check if the donation type is within range of our menu choices, if not it will prompt the user for a different input
		while(donationType < CLOTHING_CODE || donationType > OTHER_CODE)
		{
			System.out.println("You enter " + donationType + " which is not a valid donation type!");
			System.out.print("Enter " + CLOTHING_CODE + " for clothing, " + FURNITURE_CODE + " for furniture, " + ELECTRONICS_CODE + " for electronics, " + OTHER_CODE + " for anything else >> ");
			donationType = input.nextInt();
		...
		switch(donationType)
		{
			...
			case(ELECTRONICS_CODE):
			{
				...
				message = "an electronics donation type";
				break;
			}
			case(OTHER_CODE):
			{
